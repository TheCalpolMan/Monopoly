                    ...
                    for za in setinfo.houseblitpoints[setspos]:
                        if setvar == 5:
                            if setspos in [0, 1]:
                                ...
                                window.blit(self.houseimages[setspos], (za[0] - 13, za[1]))
                        else:
    ...
    for i in menus:
        if i.name == "mainmenu" and getobject(i.buttons, "button2").pressed:
            ...
            for x in i.buttons:
                ...
                try:
                    selectedcard = deck[gameinfo.players[gameinfo.playerturn].cards[cardviewcurrent]]
                except IndexError:
                    selectedcard = blankimage
        ...
        if i.name == "overlay" and i.active:
            for x in i.buttons:
                if x.name == "button2" and x.pressed:
                    gameinfo.players[gameinfo.playerturn].cards = [0, 1, 2, 5]
                    cardviewcurrent = 0
